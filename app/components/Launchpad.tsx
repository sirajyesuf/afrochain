        ...
        <div className="max-w-4xl mx-auto text-center">
          <div className="space-y-6">
            <div className="space-y-4">
              ...
              <div className="w-24 h-1 bg-[var(--brand-blue)] mx-auto rounded-full"></div>
            </div>
            ...
            <div className="flex flex-wrap justify-center gap-12 mt-12">
              <div className="text-center border-2 border-gray-200 rounded-xl p-6 bg-white shadow-sm w-32 h-32 flex flex-col justify-center">
                <div className="text-3xl lg:text-4xl font-bold text-[var(--brand-blue)] mb-2">15</div>
                <div className="text-gray-600 font-medium">Universities</div>
              </div>
              <div className="text-center border-2 border-gray-200 rounded-xl p-6 bg-white shadow-sm w-32 h-32 flex flex-col justify-center">
                <div className="text-3xl lg:text-4xl font-bold text-[var(--brand-blue)] mb-2">3</div>
                <div className="text-gray-600 font-medium">Startup Cohorts</div>
              </div>
              <div className="text-center border-2 border-gray-200 rounded-xl p-6 bg-white shadow-sm w-32 h-32 flex flex-col justify-center">
                <div className="text-3xl lg:text-4xl font-bold text-[var(--brand-blue)] mb-2">4</div>
                <div className="text-gray-600 font-medium">Hackathons</div>
              </div>
              <div className="text-center border-2 border-gray-200 rounded-xl p-6 bg-white shadow-sm w-32 h-32 flex flex-col justify-center">
                <div className="text-3xl lg:text-4xl font-bold text-[var(--brand-blue)] mb-2">50+</div>
